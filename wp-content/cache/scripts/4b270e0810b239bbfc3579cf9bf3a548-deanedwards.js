/* addPageViewCrmInfoScript: (http://reshef.webstory.co.il/wp-content/plugins/web-group-crm/js/sendPageInfoToCrmOnView.js) */
...
jQuery(function(){
    ...
    $.post({
        url :  pageInfoDataFromPhp.requestUrlToCrm + utils.createQueryStringForCrm(),
        data : data
    });
