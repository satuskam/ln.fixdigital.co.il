...
$bg_color_1   = sogo_accessibility_Option::get_option( 'btn_bg_color_1', '#20A8D8' );
$text_color_1 = sogo_accessibility_Option::get_option( 'text_color_1', '#FFF' );
$bg_color_2   = sogo_accessibility_Option::get_option( 'btn_bg_color_2', '#20A8D8' );
...
$icon         = sogo_accessibility_Option::get_option( 'btn_icon', 'fa-wheelchair' );
	...
	if ( $show ) {
        ...
        <div class="sogo-logo">
             ...
             <!--   <span><?php _e( 'Provided by:', 'sogoacc' ) ?></span> -->
                <img src="<?php echo plugin_dir_url( __FILE__ )?>css/fix_digital_logo.png" alt="FixDigital logo"/>
