=== Accordion Shortcodes ( !!! child plugin for in-go.co.il site !!! ) ===
...
This will output the following HTML:
    ...
    <div class="accordion">
        <"h3" DIV !!! class="accordion-title">Title of accordion item<"/h3" /DIV !!!>
        <div class="accordion-content">
            Drop-down content goes here.
        </div>
        <"h3" DIV !!! class="accordion-title">Second accordion item<"/h3" /DIV !!!>
        <div class="accordion-content">
            Drop-down content goes here.
        </div>
    </div>
