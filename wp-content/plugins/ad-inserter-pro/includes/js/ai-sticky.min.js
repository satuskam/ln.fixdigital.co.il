...
function ai_process_sticky_elements($){$("[data-ai-position-pc]").each(function(){var scroll_height=$("body").height()-document.documentElement.clientHeight;if(scroll_height<=0)return true;$(this).css("top",scroll_height*$(this).data("ai-position-pc"))});var ai_debug=typeof ai_debugging!=="undefined";var client_width=document.documentElement.clientWidth;var main_content_element="AI_FUNCH_GET_MAIN_CONTENT_ELEMENT".trim();var main_element=element=$(".ai-content").first();var default_margin=0;var sticky_content=
