jQuery(document).ready(function ($) {
    ...
    $(document).on('click', '.backend-product-option h2.backend-product-option-accordion', function () {
    ...
    $('#accordion-all-options input').click(function() {
        if($(this).is(':checked')) {
            $('.accordion-all-options-suboption').show();
        } else {
            $('.accordion-all-options-suboption').hide();
        }
    });

    if($('#accordion-all-options input').is(':checked')) {
        $('.accordion-all-options-suboption').show();
    } else {
        $('.accordion-all-options-suboption').hide();
    }
