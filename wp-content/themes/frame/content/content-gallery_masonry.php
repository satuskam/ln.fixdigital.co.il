...
<div id="post-<?php the_ID(); ?>" <?php post_class( apply_filters( 'pojo_post_classes', array( 'grid-item gallery-item masonry-item col-md-4 col-sm-6 col-xs-12' ), get_post_type() ) ); ?>>
	<a class="image-link" href="<?php the_permalink(); ?>">
		<?php if ( $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '600', 'crop' => true, 'placeholder' => true ) ) ) : ?>
