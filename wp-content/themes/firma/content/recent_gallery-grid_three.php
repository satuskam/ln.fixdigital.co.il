...
?>
<div <?php post_class( 'recent-gallery grid-item gallery-item col-md-4 col-sm-6 col-xs-6' ); ?>>
	<div class="inbox">
		<?php if ( $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '460', 'height' => '300', 'crop' => true, 'placeholder' => true ) ) ) : ?>
