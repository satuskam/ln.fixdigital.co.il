...
<div id="container">
	...
	<?php if ( ! pojo_is_blank_page() && is_active_sidebar( 'elementor_sidebar' ) ) : ?>
		<div id="header" class="ddd">
			<div class="container">
                <?php dynamic_sidebar( 'elementor_sidebar' ); ?>
	...
	<div id="primary" class="<?php if(is_active_sidebar( 'elementor_sidebar' )): ?>is-sidebar<?php endif; ?>">
