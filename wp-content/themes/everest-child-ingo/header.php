		...
		<header id="header" class="logo-<?php echo ( 'logo_right' === get_theme_mod( 'header_layout' ) ) ? 'right' : 'left'; ?>" role="banner">
			<div class="<?php echo WRAP_CLASSES; ?>">
				<div class="logo">
					...
					<div class="logo-img test42">
						<!-- vaa changes for search -->
						<?php if ( is_active_sidebar( 'pojo-sidebar-128' ) ) : ?>
							<div class="up-search">
								<?php dynamic_sidebar( 'pojo-sidebar-128' ); ?>
							</div>
						<?php endif; ?>
						<!-- vaa changes for search end-->
						<a class="logo-href" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo esc_attr( $logo_img ); ?>" alt="<?php bloginfo( 'name' ); ?>" class="logo-img-primary" /></a>
					</div>
					<?php else : ?>
					<div class="logo-text">
					...
					<?php endif; ?>
					<!-- vaa change for phone beg-->
					<?php if ( is_active_sidebar( 'pojo-sidebar-129' ) ) : ?>
						<div class="up-phone">
							<?php dynamic_sidebar( 'pojo-sidebar-129' ); ?>
						</div>
					<?php endif; ?>
					<!-- vaa change for phone end-->
				</div>
