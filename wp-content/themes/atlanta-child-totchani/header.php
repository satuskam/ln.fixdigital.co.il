			...
			<div class="container">
				<div class="logo">
					<?php if ( ! empty( $logo_img ) ) : ?>
						<div class="logo-img">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo esc_attr( $logo_img ); ?>" alt="<?php image_alt_from_url($logo_img); ?>" title="<?php image_title_from_url($logo_img); ?>" class="logo-img-primary" /></a>
						</div>
					<?php else : ?>
					<div class="logo-text">
