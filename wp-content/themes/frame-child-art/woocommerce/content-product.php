...
<li <?= $postClass ?> >
	<div class="inbox">
		...
		<div class="image-link">
			...
			<div class="overlay-title">
                            ...
                            <!-- <a href="<?= get_permalink(); //woocommerce_template_loop_add_to_cart(); ?>" class="button product_type_simple ajax_add_to_cart">קרא עוד</a> -->
                            
			</div>

		</div>

		<a class="caption text-center" href="<?php the_permalink(); ?>">
			<?php
			/**
    ...
    <p class="text-center price"><?= $product->get_price_html(); ?></p>
        <a href="<?= $product->add_to_cart_url(); ?>" class="single_add_to_cart_button button alt text-center">לפרטים</a>
