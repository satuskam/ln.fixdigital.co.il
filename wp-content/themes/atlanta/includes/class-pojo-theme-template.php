...
class Pojo_Theme_Template extends Pojo_Templates {
	...
	public function pojo_before_content_loop( $display_type ) {
		if ( in_array( $display_type, array( 'four_columns', 'three_columns', 'gallery_grid_three', 'gallery_grid_four' ) ) ) :
	...
	public function po_display_types( $display_types = array(), $cpt ) {
		if ( 'post' === $cpt ) {
			$display_types['blog']          = __( 'List - without Thumbnail', 'pojo' );
			$display_types['small_thumb']   = __( 'List - Small Thumbnail', 'pojo' );
			$display_types['three_columns'] = __( 'Grid - Three Columns', 'pojo' );
			$display_types['four_columns']  = __( 'Grid - Four Columns', 'pojo' );
			$display_types['masonry']       = __( 'Masonry', 'pojo' );
		}

		if ( 'pojo_gallery' === $cpt ) {
			$display_types['gallery_grid_three'] = __( 'Grid - Three Columns', 'pojo' );
			$display_types['gallery_grid_four']  = __( 'Grid - Four Columns', 'pojo' );
