		...
		<header id="header" class="logo-<?php echo ( 'logo_right' === get_theme_mod( 'header_layout' ) ) ? 'right' : 'left'; ?>" role="banner">
				...
				<nav class="nav-main" role="navigation">
					<div class="navbar-collapse collapse">
						...
						<div class="cont_a_menu">
							<ul class="sf-menu right-menu"></ul>
							<div class="img-cont logod"></div>

							<div class="left-menu-cont">
								<div class="tele-cont"><?php  dynamic_sidebar( 'pojo-' . sanitize_title( 'Top Bar Left' ) ); ?></div>
								<ul class="sf-menu left-menu"></ul>
							</div>
						</div>
			...
			<script>
				...
				(function ($)
				{
					...
					console.log($('#header .logo .logo-img'));
				})(jQuery);
