...
define( 'PW_GALLERY_URL', get_stylesheet_directory_uri() );

/**
 * Render field
 */
function pw_gallery_field( $field, $meta ) {
	wp_enqueue_script( 'pw_gallery_init', PW_GALLERY_URL . '/includes/cmb-field-gallery/js/script.js', array( 'jquery' ), null );
