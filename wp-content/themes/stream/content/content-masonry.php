...
<div id="post-<?php the_ID(); ?>" <?php post_class( apply_filters( 'pojo_post_classes', array( 'grid-item col-md-4 col-sm-6 col-xs-12' ), get_post_type() ) ); ?>>
	<div class="inbox">
		<?php if ( has_post_format( 'gallery' ) ) :
			...
			if ( ! empty( $gallery_items ) ) :
				foreach ( $gallery_items as $item_id ) :
					...
					$attachment_url = Pojo_Thumbnails::get_attachment_image_src( $item_id, array( 'width' => '420' ) );
		...
		elseif ( has_post_format( 'video' ) ) : ?>
			...
			<?php endif; ?>
		<?php else : ?>
			<?php $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '420', 'placeholder' => true ) ); ?>
