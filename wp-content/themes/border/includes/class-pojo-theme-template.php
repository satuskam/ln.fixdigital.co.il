...
class Pojo_Theme_Template extends Pojo_Templates {
	...
	public function pojo_before_content_loop( $display_type ) {
		if ( in_array( $display_type, array( 'three_columns', 'four_columns', 'gallery_grid_four', 'gallery_grid_three' ) ) ) :
			echo '<div id="grid-items" class="row hover-dir">';
		elseif ( in_array( $display_type, array( 'gallery_square' ) ) ) :
			echo '<div id="grid-items" class="hover-dir">';
		elseif ( in_array( $display_type, array( 'masonry', 'gallery_masonry' ) ) ) :
			echo '<div id="masonry-items" class="row hover-dir">';
		else :
	...
	public function pojo_recent_post_before_content_loop( $style ) {
		if ( in_array( $style, array( 'grid_three', 'grid_four' ) ) ) :
			echo '<div class="row recent-post-wrap-grid hover-dir">';
		endif;
	}
	...
	public function pojo_recent_gallery_before_content_loop( $style ) {
		if ( in_array( $style, array( 'grid_three', 'grid_four' ) ) ) :
			echo '<div class="row recent-galleries-wrap-grid hover-dir">';
		elseif ( in_array( $style, array( 'square' ) ) ) :
			echo '<div class="recent-galleries-wrap-grid hover-dir">';
		endif;
	}
	...
	public function __construct() {
		add_filter( 'po_breadcrumbs_need_to_show', array( &$this, 'hide_breadcrumbs_in_content' ), 10, 3 );
