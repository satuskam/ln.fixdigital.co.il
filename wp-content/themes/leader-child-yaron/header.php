		...
		<header id="header" class="logo-<?php echo ( 'logo_right' === get_theme_mod( 'header_layout' ) ) ? 'right' : 'left'; ?>" role="banner">
			<div class="container">
				<div class="logo col-xs-12">
					...
					<div class="smartphone-container-xs visible-xs-block">
						<a href="tel:050-2500827" class="fix_smartphone_href" role="link"><span class="fix_smartphone">050-2500827</span></a>
					</div>
				...
				<nav class="nav-main col-sm-9" role="navigation">
					...
					<div class="smartphone-container-lg hidden-xs">
						<a href="tel:050-2500827" class="fix_smartphone_href visible-lg-block visible-md-block" role="link"><span class="fix_smartphone">050-2500827</span></a>
					</div>
				</nav><!--/#nav-menu -->
