		...
		<header id="header" class="logo-<?php echo ( 'logo_right' === get_theme_mod( 'header_layout' ) ) ? 'right' : 'left'; ?>" role="banner">
			<div class="container">
				<div class="logo">
					...
					<?php endif; ?>
					<!-- vaa change beg-->
					<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Phone Sidebar") ) : ?>
					<?php endif;?>
					<!-- vaa change end-->
				</div>
				<nav class="nav-main" role="navigation">
					...
					<!-- vaa change beg-->
					<?php if ( is_active_sidebar( 'pojo-sidebar-88' ) ) : ?>
						<div class="menu1 menu1-top">
							<?php dynamic_sidebar( 'pojo-sidebar-88' ); ?>
						</div>
					<?php endif; ?>
					<!-- vaa change end-->
