...
<head>
	...
	<meta property="fb:pages" content="257125291155163">
	<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
	...
	<?php po_change_loop_to_parent( 'change' ); ?>
		...
		<header id="header" role="banner">
			<div class="<?php echo WRAP_CLASSES; ?>">
					...
					<?php if ( is_active_sidebar( 'pojo-sidebar-42' ) ) : ?>
						<div class="up-phone">
							<?php dynamic_sidebar( 'pojo-sidebar-42' ); ?>
						</div>
					<?php endif; ?>
				...
				<div class="logo">
					...
					<?php endif; ?>
					<span class="phone-mobile-menu">
						<a class="fix_smartphone_href " href="tel:0779965445" role="link">
							<span class="fix_smartphone">077-9965445</span>
						</a>
					</span>
				</div><!--.logo -->
