...
<div id="container" class="<?php echo esc_attr( str_replace( '_', '-', $layout_site ) ); ?>">
		...
		<header id="header" class="logo-<?php echo ( 'logo_right' === get_theme_mod( 'header_layout' ) ) ? 'right' : 'left'; ?>" role="banner">
			<div class="container">
				<div class="logo">
					...
					<div class="logo-img">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">><img src="<?php echo esc_attr( $logo_img ); ?>" alt="<?php image_alt_from_url($logo_img); ?>" title="<?php image_title_from_url($logo_img); ?>" class="logo-img-primary" /></a>					</div>
					<?php else : ?>
					<div class="logo-text">
					...
					<!-- vaa changes for phone -->
						<?php if ( is_active_sidebar( 'pojo-sidebar-155' ) ) : ?>
							<div class="up-phone">
								<?php dynamic_sidebar( 'pojo-sidebar-155' ); ?>
							</div>
						<?php endif; ?>
				...
				<div class="container">
					<div class="logo">
						<?php if ( ! empty( $sticky_logo_img ) ) : ?>
							<div class="logo-img">
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo esc_attr( $sticky_logo_img ); ?>" alt="<?php image_alt_from_url($sticky_logo_img); ?>" title="<?php image_title_from_url($sticky_logo_img); ?>" class="logo-img-secondary" /></a>
							</div>
						<?php else : ?>
							<div class="logo-text">
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a>
	...
	<?php endif; // end blank page ?>
		...
		<div id="primary">
			<div class="<?php echo WRAP_CLASSES; ?> test42">
				<div id="content" class="<?php echo CONTAINER_CLASSES; ?> test42">
