...
?>
<div id="post-<?php the_ID(); ?>" <?php post_class( apply_filters( 'pojo_post_classes', array( 'grid-item gallery-item col-md-3 col-sm-6 col-xs-6' ), get_post_type() ) ); ?>>
	<figure class="image-link">
		<a href="<?php the_permalink(); ?>" rel="bookmark">
			<?php if ( $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '360', 'height' => '500', 'crop' => true, 'placeholder' => true ) ) ) : ?>
