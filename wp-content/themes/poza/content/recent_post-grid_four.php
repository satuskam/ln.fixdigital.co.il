...
?>
<div <?php post_class( 'recent-post grid-item col-md-3 col-sm-6 col-xs-6' ); ?>>
	<div class="inbox">
		<?php if ( 'show' === $_current_widget_instance['thumbnail'] && $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '360', 'height' => '500', 'crop' => true, 'placeholder' => true ) ) ) : ?>
				...
				<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark">
					...
					<div class="overlay-title">
						<?php if ( 'show' === $_current_widget_instance['metadata_readmore'] ) : ?>
							<figcaption><?php echo  ! empty( $_current_widget_instance['text_readmore_mode'] ) ? $_current_widget_instance['text_readmore_mode'] : __( 'Read More &raquo;', 'pojo' ); ?></figcaption>
						<?php endif; ?>
					</div>
