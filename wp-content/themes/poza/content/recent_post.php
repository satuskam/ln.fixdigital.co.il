...
?>
<div <?php post_class( 'recent-post media blog-item' ); ?>>
	<?php if ( 'show' === $_current_widget_instance['thumbnail'] && $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '760', 'height' => '330', 'crop' => true, 'placeholder' => true ) ) ) : ?>
