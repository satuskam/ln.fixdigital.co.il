...
class Pojo_Gallery_Front {
	...
	public function pojo_gallery_print_front( $post_id = null ) {
		...
		elseif ( 'slideshow' === $gallery_type ) :
			...
			//vaa
				$big_thumb_params = array(
						'width' => '740',
						'height' => '410',
						'crop' => true,
					);
				$attachment_url = wp_get_attachment_image_src( $item_id, array(750,420) );
				$attachment_url1=Pojo_Thumbnails::get_attachment_image_src( $item_id, $big_thumb_params );
			//vaa end
