...
<div id="container" class="<?php echo esc_attr( str_replace( '_', '-', $layout_site ) ); ?>">
			...
			<div class="container">
				<div class="logo">
					...
					<?php endif; ?>
						...
						<?php if ( is_active_sidebar( 'pojo-sidebar-36' ) ) : ?>
							<div class="up-phone">
								<?php dynamic_sidebar( 'pojo-sidebar-36' ); ?>
							</div>
						<?php endif; ?>
	...
	<script>
		...
		// vaa change 17.12.04 for toglable cotegories in menu
		(function ($) {
			// vaa get viewport dementions
			function viewport() {
			...
			{
				jQuery('#menu-main-1 .menu-item-has-children,#menu-main-3 .menu-item-has-children').each(function(indx, element){
							jQuery(element).prepend('<span class="sign sign-plus">+</span><span class="sign sign-minus">&ndash;</span>');
							jQuery(element).children('span.sign').click(function(event) {
