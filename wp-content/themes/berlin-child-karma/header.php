...
<div id="container" class="<?php echo esc_attr( str_replace( '_', '-', $layout_site ) ); ?>">
	...
	if ( is_product()||is_product_category())
	{
		...
		<div class="bottomcatheader" style="background-image:linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ),url('<?php echo $image;?>')">
		<span class="animated fadeIn">

			<?php
				echo wp_get_attachment_image(2664,array(100,60));
				echo $product_top_cat_name;
			?>
		</span>
		</div>
		<?php
